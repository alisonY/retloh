...
public class JacksonUtils {
     ...
     * @since [产品/模块版本](可选)
     */
    public <T> T json2Object(String jsonStr,
                             Class<T> target) {
        T t = null;
        if (jsonStr == null) {
            try {
     ...
     */
    public <T> T json2Object(JsonNode jn,
                             Class<T> target) {
        T t = null;
        if (jn == null) {
            try {
     ...
     * @throw 异常描述
     */
    public <T> List<T> getList(String jsonVal,
                               Class<?> clazz) {
        ...
        try {
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("parse json {} to List<{}> {}", new Object[] {
                        jsonVal,
                        clazz,
                        list
                });
            ...
            LOGGER.error("paser json string {} to List<{}> error. {}", new Object[] {
                    jsonVal,
                    clazz,
                    e
            });
     ...
     * @throw 异常描述
     */
    public <T> List<T> getList(JsonNode jn,
                               Class<?> clazz) {
        if (jn == null) {
            return null;
        }
        ...
        try {
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("parse JsonNode {} to List<{}> {}", new Object[] {
                        jn,
                        clazz,
                        list
                });
            ...
            LOGGER.error("paser JsonNode {} to List<{}> error. {}", new Object[] {
                    jn,
                    clazz,
                    e
            });
