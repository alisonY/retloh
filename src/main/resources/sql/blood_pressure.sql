...
CREATE TABLE `blood_pressure_data` (
  `id` varchar(64) NOT NULL COMMENT '主键ID业务无关',
  `interval_id` varchar(64) NOT NULL DEFAULT '' COMMENT 'interval表id',
  `count` int(32) DEFAULT NULL COMMENT '次数',
