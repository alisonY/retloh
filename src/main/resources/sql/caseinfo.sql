...
CREATE TABLE `caseinfo` (
  ...
  `serial_number` int(11) DEFAULT '0' COMMENT '序列号*',
  `name` varchar(20) NOT NULL COMMENT '姓名',
  `citizen_number` varchar(20) DEFAULT NULL COMMENT '身份证号',
  `age` int(11) DEFAULT '0' COMMENT '年龄',
  `sex` varchar(10) DEFAULT NULL COMMENT '性别',
  `clinic_number` int(11) DEFAULT '0' COMMENT '门诊号',
  `bed_number` int(20) DEFAULT '0' COMMENT '床位号',
  ...
  `hospital_number` int(20) DEFAULT '0' COMMENT '医院号',
  ...
  `hospital_phonenum` int(15) DEFAULT '0' COMMENT '医院电话',
  ...
  `pacemaker_parameter` int(11) DEFAULT '0' COMMENT '起搏器参数',
  ...
  `holter_load_date` int(11) DEFAULT '0' COMMENT '回放时间',
