...
<body>
	...
	<!--对话框-->
	<div id="dlg" class="easyui-dialog" title="血压指标" style="width:800px;height:600px;padding:10px"
		data-options="
			closed:'true',
			modal:'true',
			iconCls:'icon-edit',
...
<script type="text/javascript">
	...
	function datagrid(toolbar){
		var urls = "${rootPath}${BasePath}/xueya/data/getInfo.do";
		$('#caseInfo').datagrid({
			rownumbers:true,
			pagination:true,
			fitColumns:true,
	        ...
	        {field:'systole',title:'收缩压',width:120,align:"center"},
	        {field:'diastole',title:'舒张压',width:120,align:"center"},
	        {field:'hr',title:'心率',width:120,align:"center"},
	        {field:'dataNo',title:'第几次测量',width:150,align:"center"},
	        {field:'caijiDate',title:'操作时间',width:120,align:"center"}
	        ]],
